...
It is a long-only, unit leverage, allocation on the NIKKEI 225 universe.
...
.. code:: bash
    ...
    python -m examples.strategies.nikkei225_daily
"""

import cvxportfolio as cvx

from ..universes import NIKKEI225
...
if __name__ == '__main__':
    ...
    if not RESEARCH:
        ...
        main(policy=policy, hyperparameter_opt_start=HYPERPAR_OPTIMIZE_START,
            objective=OBJECTIVE, universe=NIKKEI225, cash_key='JPYEN')
        ...
        research_sim = cvx.StockMarketSimulator(
            universe=NIKKEI225, cash_key='JPYEN')
