...
simulator = cp.MarketSimulator(
    returns, volumes, [simulated_tcost, simulated_hcost], cash_key="USDOLLAR"
)
...
optimization_tcost = cp.TcostModel(
    volume_estimate, sigma_estimate, a, b, nonlin_term=False, cash_key="USDOLLAR"
)
...
gamma_tcosts_coarse = [30, 40, 50, 60, 70, 100, 300, 1000, 3000]
