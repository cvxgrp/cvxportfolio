...
<https://github.com/cvxgrp/cvxportfolio/blob/master/examples/paper_examples/single_period_opt.py>`_.
See the docstring below for its explanation.

This is a translation of the `original IPython notebook
<https://github.com/cvxgrp/cvxportfolio/blob/0.0.X/examples/SinglePeriodOptimization.ipynb>`_
